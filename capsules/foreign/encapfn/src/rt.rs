...
use crate::types::{AccessScope, AllocScope, EFAllocation};
...
impl<'c, C: Chip> EncapfnRt<'c, C> {
    ...
    pub unsafe fn new(
        ...
        let mut mpu_config = chip.mpu().new_config().ok_or(())?;
