...
impl Sam4lDefaultPeripherals {
    ...
    pub fn setup_circular_deps(&'static self) {
        ...
        self.crccu.deferred_call.register(&self.crccu);
        self.flash_controller
            .deferred_call
            .register(&self.flash_controller);
        self.usart0.deferred_call.register(&self.usart0);
        self.usart1.deferred_call.register(&self.usart1);
        self.usart2.deferred_call.register(&self.usart2);
        self.usart3.deferred_call.register(&self.usart3);
    }
}
